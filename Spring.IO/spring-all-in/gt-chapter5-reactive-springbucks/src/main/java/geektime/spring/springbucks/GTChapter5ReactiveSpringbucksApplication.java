...
@Slf4j
public class GTChapter5ReactiveSpringbucksApplication extends AbstractR2dbcConfiguration {

    public static void main(String[] args) {
        SpringApplication.run(GTChapter5ReactiveSpringbucksApplication.class, args);
    }
